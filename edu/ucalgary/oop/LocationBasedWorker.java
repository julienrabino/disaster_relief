...
public class LocationBasedWorker {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (!exit) {
            ...
            System.out.println("9. Search Disaster Victim Family Relationships (across all locations)");
            ...
            switch (choice) {
                ...
                case "1":
                    ...
                    while (true) {
                        try {
                            DVEntry.insertDisasterVictim(locationID, disasterVictim);
                            System.out.println("Insertion of victim successful (ID: " + disasterVictim.getAssignedSocialID()+")");
                            break;
                        } catch (SQLException ex) {
                            System.out.println("Insertion of victim failed.");
                            break;
                        }
                    }
                ...
                case "3":
                    System.out.println("*** SEARCH FOR DISASTER VICTIMS IN LOCATION ***");
                ...
                case "4":
                    ...
                    try {
                        DVEntry.addDisasterVictimMedicalRecord(Integer.parseInt(victimID),  Integer.parseInt(locationID), medicalRecord);
                    } catch (SQLException e) {
