...
public class DisasterVictimEntry {
    ...
    public void insertDisasterVictim(String locationID, DisasterVictim disasterVictim) throws SQLException {
        String firstName = disasterVictim.getFirstName();
    ...
    public void addDisasterVictimMedicalRecord(int victimID, int locationID, MedicalRecord medicalRecord) throws SQLException {
        String details = medicalRecord.getTreatmentDetails();
        String treatmentDate = medicalRecord.getDateOfTreatment();
