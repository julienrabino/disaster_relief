...
*/
    ...
    public void testGetID(){
        Inquirer newInquirer = new Inquirer(1, expectedFirstName,expectedLastName,expectedPhoneNumber);
        assertEquals("getID method should return the inquirer's id", newInquirer.getID(),1);
    }
    @Test
